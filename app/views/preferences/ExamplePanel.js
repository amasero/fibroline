Ext.namespace('fibroline.views.preferences');
/**
 * @class fibroline.views.example.ExamplePanel
 * @extends Ext.Panel
 * Ejemplo de vista para la aplicacion Fibroline
 */
fibroline.views.preferences.ExamplePanel = Ext.extend(Ext.Panel, {
    id         : 'fibroline.views.preferences.ExamplePanel',
    layout     : 'card',
    fullscreen : true,
    ...
    initComponent: function() {
                    ...
                    items: [
                        {
                            ...
                            html : [
                                '<h3>Prefencias</h3>',
                                '<p>En esta vista veremos las preferencias</p>'
                            ]
                        }
                    ]
                }
        ...
        fibroline.views.preferences.ExamplePanel.superclass.initComponent.apply(this, arguments);
    },
 ...
 */
Ext.reg('fibroline.views.preferences.ExamplePanel', fibroline.views.preferences.ExamplePanel);